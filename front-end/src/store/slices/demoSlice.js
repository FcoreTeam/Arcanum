  ...
  games: [
    {
      ...
      stages: [
        ...
        },
        {
          ...
          tips: [
            "Пароль состоит из 4 цифр, цифры спрятаны в каждом логическом фрагменте видео второй главы",
            "Обратите внимание на пальцы, ключи, стихотворение и текст на двери",
            "1 цифра 4 (количество дел, которые должен сделать Джордж) 2 цифра 4 (ключи, которые остались висеть у ключника образуют силуэт цифры 4) 3 цифра 1 (первые буквы строчек стихотворения) 4 цифра 6 (Сонет 6 Уильяма Шекспира)"
          ],
          answer: "4416",
          incorrect:
